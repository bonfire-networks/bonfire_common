# defmodule Bonfire.Common.Nebulex.LocalDiskAdapter.DiskCacheHelper do
...
#     # IO.inspect(adapter_meta) # e.g: %{pid: #PID<0.7179.0>, cache: Bonfire.Common.Cache.LocalDiskCache}
