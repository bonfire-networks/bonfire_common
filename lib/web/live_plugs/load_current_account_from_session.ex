defmodule Bonfire.Common.Web.LivePlugs.LoadCurrentAccountFromSession do
  ...
  defp check_account(nil, socket), do: {:halt, push_redirect(socket, to: Routes.login_path(socket, :index))}
  defp check_account(account, socket), do: {:ok, assign(socket, current_account: account)}
